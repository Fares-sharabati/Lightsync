...
export default function SportsScreen() {
  ...
  return <main className="audience-screen ls-audience-show-screen" style={screenStyle}>
    ...
    <section className="audience-content ls-audience-show-content ls-sports-show-content">
      <header className="ls-audience-show-header"><div className="audience-brand">LIGHTSYNC</div><div className="ls-audience-live"><span /> {show?.name ?? t({ tr: 'CANLI SPOR', en: 'LIVE SPORTS' })}</div></header>
