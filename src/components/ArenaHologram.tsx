// Ambient background signature element: thin glowing line-art of a
// basketball court, football pitch, and volleyball court, cross-fading
// and drifting slowly behind page content. Purely decorative — inert to
// clicks (pointer-events disabled in CSS) and safe to drop into any page.
export default function ArenaHologram() {
    return (
      <div className="hologram-stage" aria-hidden="true">
        <svg
          className="hologram-court hologram-court--basketball"
          viewBox="0 0 500 300"
          fill="none"
          stroke="currentColor"
          strokeWidth="2"
        ...
        <svg
          className="hologram-court hologram-court--football"
          viewBox="0 0 500 325"
          fill="none"
          stroke="currentColor"
          strokeWidth="2"
        ...
        <svg
          className="hologram-court hologram-court--volleyball"
          viewBox="0 0 500 250"
          fill="none"
          stroke="currentColor"
          strokeWidth="2"
